...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, BUCK_2_Pin|AlwaysOn_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BUCK_2_Pin */
  GPIO_InitStruct.Pin = BUCK_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(BUCK_2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : AlwaysOn_Pin */
  GPIO_InitStruct.Pin = AlwaysOn_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : AlwaysOnA8_Pin AlwaysOnA9_Pin AlwaysOnA10_Pin */
  GPIO_InitStruct.Pin = AlwaysOnA8_Pin|AlwaysOnA9_Pin|AlwaysOnA10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : SEL1_Pin */
