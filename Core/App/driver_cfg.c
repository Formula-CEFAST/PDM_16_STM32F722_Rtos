...
driver_CfgType driver_CfgParam[MAX_INDICE_DRIVERS] = {
    {// Driver 0 Configuration-->PDMES16 BUCK SAIDA 1
        ...
        .self_check_running = false,
        .self_check_done = false,
        .self_check_result = false,
        .self_check_start_tick = 0,
        .self_check_pressure_start = 0.0f,
        .self_check_current_start = 0.0f,
        .self_check_drive_percent = 100,
        .self_check_ramp_ms = 1000,
        .self_check_hold_ms = 5000,
        .self_check_pressure_threshold = 3.0f,
        .self_check_current_threshold = 65535.0f,
        .counterPeriod = 100,
        .TIM_Handle = &htim3,
    ...
    {// Driver 1 Configuration-->PDMES16 BUCK SAIDA 2
        ...
        .self_check_drive_percent = 100,
        .self_check_ramp_ms = 1000,
        .self_check_hold_ms = 500,
        .self_check_pressure_threshold = 3.5f,
        .self_check_current_threshold = 65535.0f,
        .soft_start = false,
        .max_retry_count = 15,
        .max_current = 6.0f,
    ...
    {// Driver 3 Configuration -->PDMES16 SAIDA 2 HIGH CURRENT,OPAMP6,VOPAMPCHANNEL HTIM2 CH2
        ...
        .self_check_current_start = 0.0f,
        .self_check_drive_percent = 100,
        .self_check_ramp_ms = 100,
        .self_check_hold_ms = 50,
        .self_check_pressure_threshold = 3.5f,
        .self_check_current_threshold = 65535.0f,
        .error_flag = false,
        .on = false,
    ...
    {// Driver 4 Configuration
        ...
        .self_check_pressure_start = 0.0f,
        .self_check_current_start = 0.0f,
        .self_check_drive_percent = 0,
        .self_check_ramp_ms = 0,
        .self_check_hold_ms = 0,
        .self_check_pressure_threshold = 0.0f,
        .self_check_current_threshold = 65535.0f,
		.timer_wait_overcurrent=1000,
		.max_time_overcurrent=20,
		.retry_count=0
